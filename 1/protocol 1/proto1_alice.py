...
def run(addr, port):
    ...
    if rmsg["private"] == funcgroup.modinv_pow(rmsg["public"], (rmsg["parameter"]["p"]-1)*(rmsg["parameter"]["q"]-1)):
        logging.info("Public key and private key has been verified!")

    else:
        logging.info("Public key and private key has not been verified!")
